...
@endif
    ...
    <div class="col-md-6">
        <div class="card p-4">
            ...
            <form action="/updatemasyarakat/{{ $masyarakat->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-6 mb-3 text-center">
                    ...
                    <div class="position-relative" style="display: inline-block;">
                        <img id="preview"
                             src="{{ $masyarakat->foto ? asset('storage/' . $masyarakat->foto) : 'https://via.placeholder.com/150' }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('no_telepon', $masyarakat->no_telepon) }}"
                ...
                <div class="mb-3">
                    ...
                    <select name="role" id="role" class="form-control form-control-lg" required>
                        ...
                        <option value="admin" {{ old('role', $masyarakat->role) === 'admin' ? 'selected' : '' }}>Admin</option>
                        <option value="petugas" {{ old('role', $masyarakat->role) === 'petugas' ? 'selected' : '' }}>Petugas</option>
                        <option value="masyarakat" {{ old('role', $masyarakat->role) === 'masyarakat' ? 'selected' : '' }}>Masyarakat</option>
                    </select>
                </div>
