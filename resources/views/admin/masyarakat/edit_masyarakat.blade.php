                ...
                <form action="/store/masyarakat" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" value="{{old('nik'->$masyarakat->id)}}" name="nik" id="nik_masyarakat" class="form-control form-control-lg" placeholder="Masukkan NIK" value="{{ old('nik') }}" required>
                            @error('nik')
